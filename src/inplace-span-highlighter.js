 ...
 * selected text. Use <span>s to surround the highlighted elements
...
betterlink_user_interface.createModule("Span Highlighter", function(api, apiInternal) {
	...
	function insertProspectiveSubmissionStyle() {
		domUtil.addCssByClass(PROSPECTIVE_SUBMISSION_HOVER_CSS_CLASS, PROSPECTIVE_SUBMISSION_HOVER_CSS);
	}
